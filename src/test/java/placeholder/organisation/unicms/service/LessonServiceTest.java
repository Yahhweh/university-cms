...
class LessonServiceTest {
    ...
    void updateLesson_changesObject_whenCorrectDtoIsGiven() {
        ...
        LessonResponseDTO lessonResponseDTO = getLessonDto();
        long id = initial.getId();
        long studySubjectId = lessonResponseDTO.getStudySubjectId();
        ...
        lessonService.updateLesson(id, lessonResponseDTO);

        verify(lessonMapper).updateEntityFromDto(lessonResponseDTO, initial);
    ...
    void updateLesson_shouldThrowEntityValidationException_whenWrongLessonGiven() {
        ...
        assertThrows(EntityValidationException.class, () ->
                lessonService.updateLesson(lesson.getId(), lessonResponseDto)
        );
    ...
    LessonResponseDTO getLessonDto() {
